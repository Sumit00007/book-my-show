    ...
    <div className='container flex mx-auto px-4 items-center justify-between'>
      <div className='flex items-center w-1/2 gap-3'>
        <div className='w-10 h-10'>
          <img src="https://encrypted-tbn0.gstatic.c om/images?q=tbn:ANd9GcTnI_jRQb4lSx9UNElKop6LskWkn467TZsorAKkl9Wj09bMC1uin5nzY2Ms7RKXdTgkIVg&usqp=CAU" alt="logo" className='w-full h-full' />
        </div>
      ...
      <div className='flex items-center  gap-3'>
        <div className='text-gray-200 text-base flex itesm-center cursor-pointer justify-between gap-3 hover:text-white'>
          <span>
            Delhi NCR <BiChevronDown/>
          </span>
          <button className='bg-red-600 text-white px-2 py-0 text-sm rounded-md'>Sign In</button>
