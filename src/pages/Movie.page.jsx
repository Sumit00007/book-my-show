...
import { FaCcVisa, FaCcApplePay } from 'react-icons/fa6';
...
const MoviePage = () => {
  ...
  return (
    ...
    <MovieHero/>
      ...
      <div className='my-8'>
        <PosterSlider cofig={settings} title="Recommended Movies" posters ={recommendedMovies}
        isDark={false}/>
      </div>
        ...
        <div className='my-8'>
        <PosterSlider cofig={settings} title="BMS XCLUSIVE  " posters ={similarMovies}
        isDark={false}/>
        </div>
      </div>
    </>
